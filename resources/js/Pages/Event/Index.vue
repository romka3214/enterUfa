...
<template>
    ...
    <MainLayout>
        <h1 class="mt-5 mb-14 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">Все <span class="text-transparent bg-clip-text bg-gradient-to-r to-red-600 from-white">мероприятия</span></h1>
        <form>
        ...
        <div v-if="all" class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 dark:text-neutral-400 gap-3">
            ...
            <Card v-for="cell in all" :event=cell :key=cell.id />
