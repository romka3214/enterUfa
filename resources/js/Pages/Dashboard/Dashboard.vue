        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-neutral-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-neutral-900 dark:text-neutral-100">Добро пожаловать
                        {{ $page.props.auth.user.name }}!
                    </div>

                    <div class="p-6 text-neutral-900 dark:text-neutral-100">{{establishment.name}}</div>

                    <div id="default-carousel" class="relative w-full" data-carousel="slide">
                        <!-- Carousel wrapper -->
                        <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                            <!-- Item 1 -->
                            <div v-for="photo in establishment.photos" class="hidden duration-700 ease-in-out"
                                 data-carousel-item>
                                <img :src=photo.url
