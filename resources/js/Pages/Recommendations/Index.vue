...
<template>
    ...
    <MainLayout>
        ...
        <div id="vk_auth"></div>
        <div v-if="all.data" class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 dark:text-neutral-400 gap-3">

            <div class="flex flex-col w-100" v-for="cell in all.data">
                <div class="w-100 mb-4">
                    <img class="w-100 rounded-xl" :src="cell.photos[0].url" alt="">
                </div>
                <h1 class="text-xl">{{ cell.name }}</h1>
                <div class="flex flex-row gap-2">
                    <svg v-for="n in cell.average_score" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
